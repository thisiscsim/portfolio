...
export function AnimatedGroup({
  ...
  const { containerVariants, itemVariants } = useMemo(() => {
    ...
    return {
      containerVariants: variants?.container || selectedVariants.container,
      itemVariants: variants?.item || selectedVariants.item,
    }
  }, [variants, preset])

  const MotionComponent = motion[as as keyof typeof motion] || motion.div
  const MotionChild = motion[asChild as keyof typeof motion] || motion.div
